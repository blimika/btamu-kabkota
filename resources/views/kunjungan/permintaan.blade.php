    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Tambah Permintaan Baru</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h2 class="card-title text-right">Form Permintaan Baru</h2>
                <h6 class="card-subtitle text-right">Hari {{Tanggal::HariPanjang(\Carbon\Carbon::now())}}</h6>
                <!---form kunjungan baru--->
                <div class="row">
                    <div class="col-lg-2"></div>
                    <div class="col-lg-8 col-sm-12">
                        <form id="formNewPermintaan" class="form-horizontal m-t-20" action="{{route('permintaan.simpan')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <hr class="m-t-0 m-b-20">
                            @include('kunjungan.form-biodata')
...
@include('kunjungan.js-permintaan')
