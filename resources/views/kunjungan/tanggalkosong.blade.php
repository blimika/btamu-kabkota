...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">LIBUR</h4>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <h1 class="text-center">Tabel tanggal masih kosong</h1>
                        <h4 class="text-center font-italic">silakan generate tanggal dulu dari menu, Jadwal >> list jadwal</h4>
                    </div>
