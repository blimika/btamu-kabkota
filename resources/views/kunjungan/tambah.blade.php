    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <!---form kunjungan baru--->
                <form id="formNewKunjungan" class="form-horizontal m-t-20" action="{{route('kunjungan.simpan')}}" method="post" enctype="multipart/form-data">
                    @csrf
