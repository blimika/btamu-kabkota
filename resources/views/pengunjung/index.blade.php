...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Pengunjung</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Depan</a></li>
                <li class="breadcrumb-item active">Pengunjung List</li>
            </ol>
        </div>
    </div>
</div>
...
<!----batas pesan error-->
    ...
    @include('pengunjung.modal-pengunjung')
    @include('pengunjung.modal-editpengunjung')
@endsection
...
@section('js')
            ...
            $('#dTabel').DataTable({
                ...
                "fnDrawCallback": function() {
                    ...
                    $('.tabeldata').on('click','.hapuspengunjung',function(e) {
                        ...
                        Swal.fire({
                            title: 'Akan dihapus?',
                            text: "Data pengunjung " + nama + " beserta data kunjungan akan dihapus permanen",
                            type: 'warning',
    ...
    @include('pengunjung.js-pengunjung')
    @include('pengunjung.js-editpengunjung')
@stop
