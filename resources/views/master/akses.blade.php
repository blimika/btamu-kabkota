...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Akses Layanan</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Depan</a></li>
                <li class="breadcrumb-item active">Akses Layanan</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                    <h4 class="card-title">Data Akses Layanan</h4>
                    <div class="row">
                ...
                $(".ubahflagakses").click(function (e) {
                        ...
                        Swal.fire({
                                    ...
                                    if (result.value) {
                                        ...
                                        $.ajax({
                                            url : '{{route('master.ubahflagakses')}}',
                                            method : 'post',
                                            data: {
                                                id: id,
                                                ip: ipaddress,
