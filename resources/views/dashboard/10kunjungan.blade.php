                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->kunjungan_tujuan == 2)
                                            @if ($item->kunjungan_layanan_pst == 1)
                                                <span class="badge badge-success badge-pill">{{$item->Tujuan->tujuan_inisial}}
                                                </span> <span class="badge badge-info badge-pill">{{$item->LayananPst->layanan_pst_nama}}
                                                </span>
                                            @elseif ($item->kunjungan_pst == 2)
                                                <span class="badge badge-success badge-pill">{{$item->Tujuan->tujuan_inisial}}
                                                </span> <span class="badge badge-warning badge-pill">{{$item->LayananPst->layanan_pst_nama}}
                                                </span>
                                            @elseif ($item->kunjungan_pst == 3)
                                                <span class="badge badge-success badge-pill">{{$item->Tujuan->tujuan_inisial}}
                                                </span> <span class="badge badge-danger badge-pill">{{$item->LayananPst->layanan_pst_nama}}
                                                </span>
                                            @else
                                                <span class="badge badge-success badge-pill">{{$item->Tujuan->tujuan_inisial}}
                                                </span> <span class="badge badge-primary badge-pill">{{$item->LayananPst->layanan_pst_nama}}
                                                </span>
                                            @endif
                                        @else
                                            ...
                                            @elseif($item->kunjungan_tujuan == 4)
                                                <span class="badge badge-info badge-pill">{{$item->Tujuan->tujuan_nama}}
                                                </span>
                                            @elseif($item->kunjungan_tujuan == 5)
                                                <span class="badge badge-primary badge-pill">{{$item->Tujuan->tujuan_nama}}
                                                </span>
                                            @else
                                                <span class="badge badge-dark badge-pill">{{$item->Tujuan->tujuan_nama}}
                                                </span>
                                            @endif
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        @if ($item->kunjungan_petugas_uid)
                                            {{$item->Petugas->name}} <br />{!! Generate::RatingPetugas($item->kunjungan_petugas_uid) !!}
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
